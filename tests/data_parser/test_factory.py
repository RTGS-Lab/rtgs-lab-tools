...
class TestParserFactory:
    ...
    def factory(self):
        ...
        return ParserFactory(verbose=False)
    ...
    def test_init(self, factory):
        ...
        assert factory.parser_instances == {}
        assert factory.unknown_event_types == set()
        assert factory.verbose == False
    ...
    def test_create_parser_success(self, factory, mock_parser_class):
        ...
        mock_parser_class.assert_called_once_with(verbose=False)
    ...
    def test_create_parser_multiple_registered_parsers(
        self, factory, mock_parser_class_false, mock_parser_class
    ):
