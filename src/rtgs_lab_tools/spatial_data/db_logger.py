...
from sqlalchemy import text, Column, Integer, String, Text, DateTime, Boolean, Numeric, ARRAY
...
class SpatialDataLogger:
        ...
        try:
            ...
            with self.engine.connect() as conn:
                ...
                if not postgis_exists:
                    logger.warning("PostGIS extension not found. Tables will be created without spatial features.")
    ...
    def get_dataset_info(self, dataset_name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            session = self.Session()
            try:
                dataset = session.query(SpatialDataset).filter_by(
    ...
    def get_extraction_history(self, dataset_name: str, limit: int = 10) -> List[Dict[str, Any]]:
                ...
                return [
                    {
                        ...
                        "duration_seconds": float(ext.duration_seconds) if ext.duration_seconds else None,
                        "output_file": ext.output_file,
                        "file_size_mb": float(ext.file_size_mb) if ext.file_size_mb else None,
                        "crs": ext.crs,
    ...
    def get_dataset_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                successful_extractions = session.query(SpatialExtraction).filter_by(success=True).count()
