...
def enable_postgres_logging() -> None:
    ...
    logger.info("Note: Set POSTGRES_LOGGING_STATUS=true in your .env file to persist this setting")
...
def disable_postgres_logging() -> None:
    ...
    logger.info("Note: Set POSTGRES_LOGGING_STATUS=false in your .env file to persist this setting")
