...
def reproduce(logs_dir, output_file):
    ...
    try:
        ...
        script_result = report_service.generate_reproduction_script(log_files, output_file_path)
        ...
        if not script_result["success"] and "dirty_commands" in script_result:
            ...
            audit_service.log_audit_operation("Generate reproduction script from files", parameters, results)
            return
